...
const StudentManagement = () => {
  ...
  const handleDeleteStudent = async (userId) => {
    try {
      const response = await fetch(`http://localhost:8080/student/delete/${userId}`, {
        method: "DELETE",
      });
  ...
  const handleSubmit = async (e) => {
    ...
    const url = isEditing ? `http://localhost:8080/student/update/${formData.userId}` : "http://localhost:8080/student/add";
  ...
  return (
    <div className="min-h-screen py-2 px-4">
      <div className="flex justify-between items-center mb-4">
        ...
        >
          {showForm ? "Cancel" : isEditing ? "Cancel Edit" : "Add Student"}
        </button>
      </div>
